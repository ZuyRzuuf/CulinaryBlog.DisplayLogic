...
public class CuisineTypeTests
{
    [Fact]
    public void CuisineType_Schema_Snapshot()
    {
        // Arrange
    ...
    [Fact]
    public void CuisineType_Fields_ExistAndAreCorrectType()
    {
        // Arrange
        var schema = SchemaBuilder.New()
            .AddQueryType<QueryType>()
        ...
        // Act
        var fields = schema.GetType<ObjectType>("Cuisine").Fields;
